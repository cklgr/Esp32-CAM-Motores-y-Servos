...
static esp_err_t cmd_handler(httpd_req_t *req)
{
  ...
  else if(!strcmp(variable, "servoazul")) // 3250, 4875, 6500
    {
      if      (val > 650) val = 650;
      else if (val < 325) val = 325;       
      ledcWrite(11,10*val);     
        ...
        <style>
		  ...
		  #nav-toggle-cb:checked+#menu{display:flex}.input-group{display:flex;
													...
													.close{position:absolute;
														   ...
														   color:#fff;
														   text-align:center;
														   line-height:18px;cursor:pointer}.hidden{display:none}
        </style>
    </head>
    <body>
    <figure>
      <div id="stream-container" class="image-container hidden">
        ...
        <section class="main">
            <section id="buttons">
				...
				<tr>
					<td>ServoTILT</td>
					<td align="center" colspan="2"><input type="range" id="servo" min="200" max="900" value="550" onchange="try{fetch(document.location.origin+'/control?var=servo&val='+this.value);}catch(e){}"></td>
				</tr>
        <tr>
					<td>ServoPAN</td>
					<td align="center" colspan="2"><input type="range" id="servopan" min="200" max="800" value="500" onchange="try{fetch(document.location.origin+'/control?var=servopan&val='+this.value);}catch(e){}"></td>
				</tr>
        <tr>
         <td>Servo3</td>
          <td align="center" colspan="2"><input type="range" id="servo3" min="200" max="800" value="500" onchange="try{fetch(document.location.origin+'/control?var=servo3&val='+this.value);}catch(e){}"></td>
        </tr>
        <td>ServoAZUL</td>
          <td align="center" colspan="2"><input type="range" id="servoazul" min="200" max="800" value="500" onchange="try{fetch(document.location.origin+'/control?var=servoazul&val='+this.value);}catch(e){}"></td>
        </tr>
